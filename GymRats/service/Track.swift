...
enum Track {
  enum Event: String {
    ...
    case autoSyncToggled = "auto sync toggled"
    case tappedAllowHealthApp = "tapped allow health app"
  }
  ...
  enum Screen: String {
    ...
    case profile
    case workout
    case healthAppSettings = "health app settings"
    case challenge
    ...
    case enterWorkoutData = "enter workout data"
  ...
  static func event(_ event: Track.Event, properties: JSON? = nil) {
    GymRats.segment.track(event.rawValue.capitalized, properties: properties)
  }

  static func screen(_ screen: Track.Screen, properties: JSON? = nil) {
    GymRats.segment.screen(screen.rawValue.capitalized, properties: properties)
  }
}
